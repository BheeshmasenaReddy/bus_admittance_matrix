...
s2='[[1,2,0,0.1],[3,4,0,0.1],[1,4,0,0.2],[1,3,0,0.5],[2,3,0,0.2],[1,0,0,0.2]]'
def adm_mat(p):
    linedata=eval(s2)

    #Reading linedata
    fb=[i[0] for i in linedata]
    tb=[i[1] for i in linedata]
    r=[i[2] for i in linedata]
    x=[i[3] for i in linedata]
